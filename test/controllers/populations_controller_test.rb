...
class PopulationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create population" do
    assert_difference('Population.count') do
      post populations_url, params: { population: { continent: @population.continent, country: @population.country, population: @population.population, rank: @population.rank, year: @population.year } }
    end
  ...
  test "should update population" do
    patch population_url(@population), params: { population: { continent: @population.continent, country: @population.country, population: @population.population, rank: @population.rank, year: @population.year } }
